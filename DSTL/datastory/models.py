...
class Attitude(models.Model):
    ...
    def __str__(self):
        return "Intended Audience's Attitude: %s" % self.attitude
...
class Strategy(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['strategy', 'argument', 'motivation', "attitude"], name='unique_strategy')
        ]
...
class Datastory(models.Model):
    ...
    story_content = models.CharField(max_length=120)
    ...
    def __str__(self):
        return "Datastory Template: %s" % self.story_content
    ...
    class Meta:
        ordering = ['dimension']
        unique_together = (('strategy', 'dimension'),)
        constraints = [
            UniqueConstraint(fields=['strategy', 'dimension'], name='unique_datastory')
        ]
